    ...
    <div className={styles.Dashboard}>
     ...
     <div className={styles.DashboardRight}>
      <div className={styles.DashboardRightTopCard}>
        ...
        <img className={styles.profileImg} src={"https://photosly.in/wp-content/uploads/2024/04/cute-dp-for-girls_3.jpg"} />
      ...
      <Skeleton variant='rectangular' sx={{borderRadius:"20px"}} width={370} height={300}/>
     </div>
    </div>
  )
}
